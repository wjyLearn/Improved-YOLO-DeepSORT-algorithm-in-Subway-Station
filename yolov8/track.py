...
from ultralytics.yolo.utils.torch_utils import select_device, strip_optimizer
...
def run(
        ...
        reid_weights=WEIGHTS / 'osnet_x0_25_msmt17.pth',  # model.pt path,
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=r"D:\WJY\project\Headshoulder\yolov5masterdeepsort1129done\data\video\楼梯.mp4", help='file/dir/URL/glob, 0 for webcam')
    ...
    parser.add_argument('--save-trajectories', action='store_true', default = True,help='save trajectories for each track')
